...
\title[MalGuard: Predictive Modeling for Malware Detection in Windows Systems using Ensemble Learning]{MalGuard: Predictive Modeling for Malware Detection in Windows Systems using Ensemble Learning}
...
\author*[3]{\fnm{Yik Ting} \sur{Lam}}\email{lam.yikting@dhs.edu.sg}
